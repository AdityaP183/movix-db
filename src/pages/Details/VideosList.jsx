						...
						{data?.results?.map((video) => (
							<li key={video.id} className="videoItem w-[280px] h-[190px]">
								<div
									...
									className="relative w-[280px] hover:opacity-70 cursor-pointer transition-all .7s ease-in-out"
								>
									<LazyLoadingImage
										imgUrl={`https://img.youtube.com/vi/${video.key}/mqdefault.jpg`}
										imgwidth={"100%"}
										imgheight={"100%"}
									/>
								...
								<h4 className="name text-white text-center text-[16px] break-words">
									{video.name}
								</h4>
							</li>
						))}
